  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <Section title="Overview">
        <p>SkillHive Marketplace ("SkillHive", "we", "us") is committed to protecting your privacy. This policy explains what data we collect, how we use it, and what choices you have.</p>
        <p>SkillHive is a non-custodial platform — we never hold your SOL or private keys. All payments settle directly on the Solana blockchain.</p>
      </Section>

      <Section title="Data we collect">
        <p><strong className="text-foreground">Wallet address.</strong> When you connect a wallet, we record your public key to associate skill ownership, call history, reputation scores, and free-use quotas with your account. Your public key is visible on the Solana blockchain regardless of SkillHive.</p>
      ...
      <Section title="Your rights">
        <p>You may request deletion of your data (except on-chain records, which are permanent by Solana design) by opening an issue on our{' '}
          <a href="https://github.com/windyinwind/skillhive-marketplace/issues" target="_blank" rel="noopener noreferrer" className="text-[#9945FF] hover:underline">GitHub repository</a>.
        </p>
      </Section>

      <Section title="Changes to this policy">
        <p>We may update this policy. Material changes will be announced on{' '}
          <a href="https://x.com/skillhive.market" target="_blank" rel="noopener noreferrer" className="text-[#9945FF] hover:underline">X / Twitter</a>{' '}
      ...
      <div className="rounded-xl border bg-card px-6 py-4 text-sm text-muted-foreground" style={{ borderColor: 'var(--border-subtle)' }}>
        ...
        <a href="https://github.com/windyinwind/skillhive-marketplace/issues" target="_blank" rel="noopener noreferrer" className="text-[#9945FF] hover:underline">GitHub</a>.
      </div>
    </div>
  )
}
